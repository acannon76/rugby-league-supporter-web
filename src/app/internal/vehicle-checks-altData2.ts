...
export const altStatusStorageKey = "hgv-backup2-alt-vehicle-check-status";
export const altMileageStorageKey = "hgv-backup2-alt-current-mileage-km";
export const altHistoryStorageKey = "hgv-backup2-alt-vehicle-check-history-extra";
...
export const altLogbookStorageKey = "hgv-backup2-alt-vehicle-check-logbook";

...
const sidebarItems = [
  ...
  { label: "Comms", icon: "💬", href: "/internal/app-ideas/link-message-mock/comms" },
  ...
  { label: "History", icon: "HIS", href: "/internal/app-ideas/link-message-mock/comms/history", active: true },
];

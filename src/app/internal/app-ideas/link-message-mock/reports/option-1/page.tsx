...
export default function ReportsOptionOnePage() {
  ...
  return (
    <div className="min-h-screen bg-[#eef2f6] text-[#111827]">
      <OfficeHeader title="MOCK UP" subtitle="Reports Option 1" />
          ...
          <section className="rounded-[24px] border border-[#d6dde8] bg-white p-5 shadow-sm sm:p-6">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              <div>
                ...
                <h1 className="mt-2 text-3xl font-black text-[#10203a]">Reports Option 1</h1>

...
export const arrivalBoardRows: ArrivalDepartureRow[] = [
  {
    ...
    resources: "Murray Dean • PRE211 (PN72MSH) • 24160021",
    traffic: trafficOptions[0],
    delay: "+00:07",
  },
  {
    ...
    resources: "Taylor Emma • NWH602 (PX25HUB) • 7338014",
    traffic: trafficOptions[5],
    delay: "00:00",
  },
  {
    ...
    resources: "Wilson David • MAN118 (MX21DCT) • 20316087",
    traffic: trafficOptions[3],
    delay: "-00:04",
  },
  {
    ...
    resources: "James Walker • HCN075 (PN75HCN) • 26311976",
    traffic: trafficOptions[1],
    delay: "00:00",
  },
  {
    ...
    resources: "Laura Hughes • PEV301 (PN74PEV) • 25316089",
    traffic: trafficOptions[2],
    delay: "-00:09",
  },
  {
    ...
    resources: "Sarah Green • WAR884 (MX74FDN) • 4318005",
    traffic: trafficOptions[4],
    delay: "+00:11",
  },
  {
    ...
    resources: "Rachel Evans • CRY902 (PN70VOC) • 24316007",
    traffic: trafficOptions[0],
    delay: "00:00",
  },
  {
    ...
    resources: "Barrett Duncan • LON455 (PO75YXH) • 26316006",
    traffic: trafficOptions[3],
    delay: "00:00",
  },
  {
    ...
    resources: "Selwood Andy • BOU147 (PN74CHC) • 26316023",
    traffic: trafficOptions[1],
    delay: "+00:05",
  },
  {
    ...
    resources: "Adam Evans • YDC611 (PN25BVL) • 4055",
    traffic: trafficOptions[5],
    delay: "+00:03",
  },
];

...
import VehicleCheckTimer, { startVehicleCheckTimer } from "../vehicle-checks2/VehicleCheckTimer";
...
useEffect(() => {
  const frame = window.requestAnimationFrame(() => {
    const savedExtraHistory = window.localStorage.getItem(
      "hgv-backup2-mock-vehicle-history-extra"
    );
...
function clearAddedMockHistory() {
  window.localStorage.removeItem("hgv-backup2-mock-vehicle-history-extra");

...
const checks: VehicleCheck[] = [
  {
    ...
    href: "/internal/vehicle-checks2/brake-system-defects",
    active: true,
  },
  {
    number: 2,
    title: "Steering & Controls",
    href: "/internal/vehicle-checks2/steering-controls",
    active: true,
  },
  {
    number: 3,
    title: "Tyres Wheels & Suspension",
    href: "/internal/vehicle-checks2/tyres-wheels-suspension",
    active: true,
  },
  {
    number: 4,
    title: "Light, Visibility & Warning Devices",
    href: "/internal/vehicle-checks2/lights-visibility-warning-devices",
    active: true,
  },
  {
    number: 5,
    title: "Trailer & Coupling Checks",
    href: "/internal/vehicle-checks2/trailer-coupling-defects",
    active: true,
  },
  {
    number: 6,
    title: "Load Security & Vehicle Security",
    href: "/internal/vehicle-checks2/load-security-vehicle-security",
    active: true,
  },
  {
    number: 7,
    title: "Fluid Leaks & Mech Failures",
    href: "/internal/vehicle-checks2/fluid-leaks-mechanical-failures",
    active: true,
  },
  {
    number: 8,
    title: "Legal & Compliance",
    href: "/internal/vehicle-checks2/legal-compliance-failures",
    active: true,
  },
  {
    number: 9,
    title: "Safety Equipment & Emergency Systems",
    href: "/internal/vehicle-checks2/safety-equipment-emergency-systems",
    active: true,
  },
  {
    number: 10,
    title: "Structural & General Condition",
    href: "/internal/vehicle-checks2/structural-general-vehicle-condition",
    active: true,
  },
];

const statusStorageKey = "hgv-backup2-vehicle-check-status";
const mileageStorageKey = "hgv-backup2-current-mileage-km";
...
export default function VehicleChecksPage() {
  ...
  function continueToSummary() {
    ...
    window.location.href = "/internal/vehicle-checks2/summary";
  }
  ...
  <VehicleCheckTimer />
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <Link
              href="/internal/vehicle-history2"

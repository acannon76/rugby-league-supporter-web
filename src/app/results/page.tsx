      ...
      <div className="mx-auto max-w-[1180px]">
        ...
        <section className="mb-6 rounded-[34px] border-[3px] border-[#111] bg-[#d81e05] p-6 text-[#111] sm:p-8 lg:p-10">
          ...
          <p className="mt-5 max-w-[760px] text-sm font-extrabold leading-6 sm:text-base lg:text-lg">
            Completed matches, final scores and venues. Latest results are
            shown first.
          </p>
        </section>

        <section className="mb-8 grid gap-4 md:grid-cols-[0.8fr_1.2fr]">
          <SummaryBox title="Results" value={results.length} />

          <LatestResultBox game={latestResult} />
        </section>
        ...
        <section>
          <SectionHeading
            ...
            text="Results are grouped by match date, with the newest date at the top."
          />
  ...
  return (
    <article className="rounded-[28px] border-[3px] border-[#111] bg-[#f5ede0] p-5 text-[#111] transition hover:-translate-y-1 hover:shadow-lg">
      <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
        ...
        <span className="rounded-full bg-[#111] px-4 py-2 text-xs font-black tracking-widest text-white">
          FT
        </span>
      </div>
      ...
      <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-3">
        ...
        <div className="rounded-2xl bg-[#111] px-4 py-3 text-center text-white">
          {hasScore ? (
...
function LatestResultBox({ game }: { game?: DisplayGame }) {
  if (!game) {
    return (
      <div className="rounded-[24px] border-[3px] border-[#111] bg-[#111] p-5 text-white">
        ...
        <p className="mt-2 text-2xl font-black">No result found</p>
      </div>
    );
  }
